...
ouvrez le lien contenu dans cet email ;

choisissez votre mot de passe ;

votre compte est ensuite utilisable depuis /admin/login.
...
choisir Inviter un administrateur ;

renseigner son nom et son adresse email ;

sélectionner ses permissions pour chaque module ;
